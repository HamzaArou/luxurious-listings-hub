  ...
  return (
    <section className="py-24 bg-darkBlue text-white">
      <div className="container mx-auto px-4 max-w-[960px]">
        <h2 className="text-4xl font-bold text-center mb-12">اتصل بنا</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div>
            <form className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full py-3 bg-gold text-darkBlue font-bold rounded hover:bg-opacity-90 transition-colors"
              >
                إرسال
              </button>
            </form>
          ...
          <div className="space-y-8">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="font-bold mb-1">موقعنا</h3>
